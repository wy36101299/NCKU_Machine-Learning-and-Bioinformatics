...
#   assert os.path.exists(gnuplot_exe),"gnuplot executable not found" // remarked by dirty
    assert os.path.exists(dataset_pathname),"dataset not found"
#   gnuplot = popen(gnuplot_exe,stdin = PIPE).stdin // remarked by dirty
...
#       redraw(db,[best_c1, best_g1, best_rate]) // remarked by dirty
#       redraw(db,[best_c1, best_g1, best_rate],True) // remarked by dirty
